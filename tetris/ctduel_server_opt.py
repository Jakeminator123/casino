...
# Prefer eventlet if available (better websockets), else fallback to threading
...
GAMES = {}         # room -> DuelGame
SESS = {}          # sid -> (room, pid)
BG = {}            # room -> background task

@app.route('/')
def root():
    return send_from_directory('.', 'ctduel_client_opt.html')
...
if __name__ == '__main__':
    ...
    # debug off to avoid watchdog/reloader jitter
